...
// manner.
func NewLightningChannel(signer contextsigner.ChannelContextSigner,
...
func newOutgoingHtlcResolution(signer contextsigner.ChannelContextSigner,
	...
	timeoutWitness, err := input.SenderHtlcSpendTimeout(
		htlcSig, sigHashType, signer.Hack(), &timeoutSignDesc, timeoutTx,
	)
	if err != nil {
		return nil, err
	}
...
func newIncomingHtlcResolution(signer contextsigner.ChannelContextSigner,
	localChanCfg *channeldb.ChannelConfig, commitHash chainhash.Hash,
	htlc *channeldb.HTLC, keyRing *CommitmentKeyRing,
	...
	successWitness, err := input.ReceiverHtlcSpendRedeem(
		htlcSig, sigHashType, nil, signer.Hack(), &successSignDesc, successTx,
	)
	if err != nil {
		return nil, err
	}
